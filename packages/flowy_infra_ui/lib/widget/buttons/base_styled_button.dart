    ...
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: _isFocused
            ? [
                BoxShadow(color: Colors.grey, offset: Offset.zero, blurRadius: 8.0, spreadRadius: 0.0),
                BoxShadow(
                    color: widget.bgColor ?? Colors.grey, offset: Offset.zero, blurRadius: 8.0, spreadRadius: -4.0),
              ]
            : [],
      ),
      ...
      child: RawMaterialButton(
        ...
        hoverColor: widget.hoverColor ?? Colors.grey,
        highlightColor: widget.downColor ?? Colors.grey,
